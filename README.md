...
<div align="center">
  <h2>food delivery application project</h2>
...
- food delivery application project Customer App
- food delivery application project Rider App
- food delivery application project Restaurant App
...
Find the link for the complete documentation of the food delivery application project [here](https://enatega.com/multivendor-documentation/).
...
[Check out the Product Page and Pricing and more for food delivery application project](https://enatega.com/?utm_source=github&utm_medium=repo&utm_campaign=tiffanie-food-delivery-application-project)
